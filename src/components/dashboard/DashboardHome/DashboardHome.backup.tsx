        ...
        {isLoadingStats ? (
          <div className="dashboard-home__stats-overview-card">
            <div className="dashboard-home__stats-overview-header">
              <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--title" />
              <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--subtitle" />
            </div>
            ...
            <div className="dashboard-home__stats-overview-grid">
              <section className="dashboard-home__stats-summary">
                <div className="dashboard-home__stats-summary-grid">
                  {/* Skeleton dla 3 summary items */}
                  {[1, 2, 3].map((item) => (
                    <article
                      key={item}
                      className="dashboard-home__stats-summary-item dashboard-home__stats-summary-item-skeleton"
                    >
                      <div className="dashboard-home__stats-summary-heading">
                        <div className="dashboard-home__stats-summary-icon-skeleton" />
                        <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--small" />
                      </div>
                      <div className="dashboard-home__stats-summary-value-skeleton" />
                      <dl className="dashboard-home__stats-summary-meta">
                        {[1, 2, 3].map((meta) => (
                          <div key={meta}>
                            <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--meta-label" />
                            <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--meta-value" />
                          </div>
                        ))}
                      </dl>
                    </article>
              ...
              <div className="dashboard-home__stats-detail">
                {/* Skeleton dla ostatnich odpowiedzi */}
                <div className="dashboard-home__stat-item dashboard-home__stat-item--recent">
                  <div className="dashboard-home__stat-item-header">
                    <div className="dashboard-home__stat-item-icon-circle-skeleton" />
                    <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--label" />
                  </div>
                  <div className="dashboard-home__stat-item-recent-list">
                    {[1, 2].map((item) => (
                      <div key={item} className="dashboard-home__stat-item-recent-item">
                        <div className="dashboard-home__stat-item-recent-avatar-skeleton" />
                        <div className="dashboard-home__stat-item-recent-info">
                          <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--name" />
                          <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--time" />
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {/* Skeleton dla następnego wydarzenia */}
                <div className="dashboard-home__stat-item dashboard-home__stat-item--next-event">
                  <div className="dashboard-home__stat-item-header">
                    <div className="dashboard-home__stat-item-icon-circle-skeleton" />
                    <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--label" />
                  </div>
                  <div className="dashboard-home__stat-item-next-event-content">
                    <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--event-title" />
                    <div className="dashboard-home__stat-item-next-event-details">
                      {[1, 2, 3].map((detail) => (
                        <div key={detail} className="dashboard-home__stat-item-next-event-detail">
                          <div className="dashboard-home__stat-item-icon-skeleton" />
                          <div className="dashboard-home__stats-overview-skeleton-line dashboard-home__stats-overview-skeleton-line--detail" />
                        </div>
                      ))}
                    </div>
                  </div>
                  <div className="dashboard-home__stat-item-next-event-btn-skeleton" />
                </div>
              </div>
            </div>
          </div>
                  ...
                  {summaryTiles.map(tile => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="dashboard-home__stats-summary-value">
                          {tile.value}
                          {tile.id === 'events' && (
                            <span className="dashboard-home__stats-summary-unit">
                              {tile.value === 1 ? ' wydarzenie' : tile.value > 1 && tile.value < 5 ? ' wydarzenia' : ' wydarzeń'}
                            </span>
                          )}
                          {tile.id === 'guests' && (
                            <span className="dashboard-home__stats-summary-unit">
                              {tile.value === 1 ? ' gość' : tile.value > 1 && tile.value < 5 ? ' gości' : ' gości'}
                            </span>
                          )}
                          {tile.id === 'avg' && (
                            <span className="dashboard-home__stats-summary-unit"> gość/wydarz.</span>
                          )}
                        </div>
                        <dl className="dashboard-home__stats-summary-meta">
                          {tile.meta.map(item => (
                ...
                <div className="dashboard-home__stat-item-recent-list">
                  {recentResponses.length > 0 ? (
                    <>
                      ...
                      {/* Maksymalnie 1 pusty slot, tylko jeśli nie ma 3 odpowiedzi */}
                      {recentResponses.length < 3 && (
                        <div className="dashboard-home__stat-item-recent-item dashboard-home__stat-item-recent-item--empty">
                          <div className="dashboard-home__stat-item-recent-avatar dashboard-home__stat-item-recent-avatar--empty">
                            <MessageSquare size={16} />
                          </div>
                          <div className="dashboard-home__stat-item-recent-info">
                            <span className="dashboard-home__stat-item-recent-name dashboard-home__stat-item-recent-name--empty">
                              {recentResponses.length === 0 ? 'Brak odpowiedzi' : 'Brak więcej odpowiedzi'}
                            </span>
                          </div>
                        </div>
                      )}
                    ...
                    // Gdy nie ma żadnych odpowiedzi, pokaż jeden pusty slot
                    <div className="dashboard-home__stat-item-recent-item dashboard-home__stat-item-recent-item--empty">
                      <div className="dashboard-home__stat-item-recent-avatar dashboard-home__stat-item-recent-avatar--empty">
                        <MessageSquare size={16} />
                      </div>
